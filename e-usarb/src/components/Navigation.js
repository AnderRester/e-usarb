...
const Navigation = () => {
    return <View style={{ backgroundColor: '#56926d', paddingVertical: 15, paddingBottom: 30, paddingHorizontal: 32, alignItems: 'center', justifyContent: 'space-between', flexDirection: 'row', textAlign: 'center' }}>
